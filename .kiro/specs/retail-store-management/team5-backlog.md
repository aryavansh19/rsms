...
| Points 1/2/3/5/8 | 1 / 24 / 43 / 2 / 4 |

## Sprint Capacity Plan

Total capacity = 630 hrs (Week 1: 189, Week 2: 252, Week 3: 189). 
Uniform velocity = 630 / 220 = **2.86 hrs per story point**. Points track hours directly.

| Sprint | Theme | Stories | Points | Capacity (hrs) | Points x rate |
|--------|-------|---------|--------|----------------|---------------|
| 1 | Foundation + setup + transfers | 26 | 66 | 189 | 189 |
| 2 | Commerce + events + analytics | 24 | 89 | 252 | 255 |
| 3 | After-sales + submissions | 24 | 65 | 189 | 186 |
| **Total** | | **74** | **220** | **630** | **630** |

_Week 1 = 66 pts = 189 hrs (exact). Proportional targets 66/88/66; allocated 66/89/65. Sprint 3 sits slightly under capacity to absorb section-5 submissions (demo video, memory profile, flow diagram)._

## Sprint 1 (26 stories, 66 pts)
